...
class HomeView: UIView {
    ...
    // MARK: - UI Properties
    let availableBalanceView = RoundedView()
    ...
    let accountCurrencyLabel: StyledLabel = {
        ...
        label.text = "accountCurrency".localized
        return label
    }()
    ...
    // My Cards Table View
    let containerMyCardsTableView = RoundedView()
    
    let myCardsLabel: StyledLabel = {
        let label = StyledLabel(textStyle: .titleMedium)
        label.text = "myCardsTitle".localized
        return label
    }()
    ...
    let containerTransactionsCollectionView = RoundedView()
    
    let recentTransactionsLabel: StyledLabel = {
        let label = StyledLabel(textStyle: .titleMedium)
        label.text = "recentTransactionsTitle".localized
        return label
    }()
