...
extension SingleCardViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func setupCollectionView() {
        singleCardView.buttonsCollectionView.delegate = self
        singleCardView.buttonsCollectionView.dataSource = self
        singleCardView.buttonsCollectionView.register(ButtonsCollectionViewCell.self, forCellWithReuseIdentifier: Cells.buttonsCell)
        singleCardView.buttonsCollectionView.isScrollEnabled = false
    }
